              ...
              <q-list class="shadow-2 rounded-borders" style="min-width: 100px; padding-top: 1.5%; padding-bottom: 1%;" bordered>
                <q-item clickable v-ripple>
                  ...
                  <q-item-section class="row justify-center">
                    <q-item-label class="ellipsis" title="Le véhicule n°15 vient de démarrer. Il part vers le centre d'Angoulême.">Le véhicule n°15 vient de démarrer. Il part vers le centre d'Angoulême.</q-item-label>
                ...
                <q-item clickable v-ripple>
                  ...
                  <q-item-section class="row justify-center">
                    <q-item-label class="ellipsis" title="Le véhicule N°3 est en mouvement.">Le véhicule N°3 est en mouvement.</q-item-label>
                    <q-item-label caption lines="1"> Catégorie : Géofencing</q-item-label>
                  </q-item-section>
                  <q-item-section side top>
                    <q-item-label caption>Il y a 5 min</q-item-label>
                ...
                <q-item clickable v-ripple>
                  ...
                  <q-item-section class="row justify-center">
                    <q-item-label class="ellipsis" title="Le D'click N°6 a une anomalie batterie. Un technicien se rend sur place.">Le D'click N°6 a une anomalie batterie. Un technicien se rend sur place.</q-item-label>
